        ...
        knex("book_author").del()
            ...
            return Promise.all([
                ...
                knex('author').insert({
                    first_name: 'Kyle',
                    last_name: 'Simpson',
                    biography: 'Kyle Simpson is an Open Web Evangelist who is passionate about all things JavaScript. He is an author, workshop trainer, tech speaker, and OSS contributor/leader',
...
function getBookIdByTitle(bookTitle, knex, Promise){
    return new Promise(function(resolve, reject){
        console.log("trying to get bookTitle " + bookTitle);
        knex("book").select("id").where("title", bookTitle).first()
            .then(function(book){
